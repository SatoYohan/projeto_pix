...
public class ClientHandler implements Runnable {
    ...
    public void run() {
        try (
            ...
            while ((jsonRequest = in.readLine()) != null) {
                ...
                try {
                    // 1. O validador (v1.5) valida tudo, inclusive 'conectar'.
                    ...
                    // 3. ESTA LINHA AGORA VAI FUNCIONAR
    ...
    private String handleTransacaoLer(JsonNode node) {
        ...
        Usuario usuarioLogado = Server.usuarios.get(cpf);
    ...
    /**
     * (Item 4.11) Apenas loga o erro reportado pelo cliente.
     */
    ...
    private String handleTransacaoCriar(JsonNode node) {
        ...
        // 3. Verifica o saldo (Transação Atômica)
        // Usamos 'synchronized' para garantir que dois PIX não aconteçam ao mesmo tempo
    ...
    private ObjectNode criarJsonDaTransacao(Transacao tx) {
        ...
        // Protocolo 4.8 pede "atualizado_em", vamos usar o "criado_em"
